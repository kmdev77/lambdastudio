...
import thumbsLeft from "./assets/thumbs-left-2.png";
...
export default function App() {
    ...
    // FIX: force a reflow on orientation/resize so measured layouts & CSS recalculates settle
    ...
    async function downloadResized() {
        ...
        try {
            ...
            // data: URL or same-origin fallback 
            if (/^data:/i.test(href)) {
                const a = document.createElement("a");
                a.href = href;
